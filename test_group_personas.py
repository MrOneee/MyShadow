...
from bot import Bot, prompt_for
...
class PersonaTests(unittest.TestCase):
    def setUp(self):
        ...
        self.bot.personas=load_personas(self.bot.config,Path(__file__).parent)
    ...
    def test_scheduled_ai_uses_task_group_persona(self):
        ...
        with patch('bot.chat_complete',return_value=('蒋丞。',{})) as complete:
            b.run_scheduled([B])
    ...
    def test_activity_host_and_commands_use_current_group_identity(self):
        ...
        registry=Registry(Path(__file__).parent/'skills',['turtle_soup'])
