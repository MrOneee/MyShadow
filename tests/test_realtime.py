...
from myshadow.realtime import Weather, chat_complete, clock_context


class ClockTests(unittest.TestCase):
    def test_clock_is_shanghai_not_server_default_timezone(self):
        with patch('myshadow.realtime.datetime') as clock:
...
class ToolTests(unittest.TestCase):
    ...
    def test_confirmed_sticker_only_stops_without_another_model_call(self):
        from myshadow.native_stickers import STICKER_TOOLS
