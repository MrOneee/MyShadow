...
from myshadow.background_knowledge import BackgroundKnowledge,build_index,BACKGROUND_TOOL
...
class BackgroundTests(unittest.TestCase):
    ...
    def test_worker_offers_tool_with_host_bound_scope(self):
        ...
        with patch('myshadow.bot.chat_complete',return_value=('怎么，找他有事？',{})) as complete:
    ...
    def test_no_match_is_explicit_and_prompt_budget_is_group_scoped(self):
        ...
        from myshadow.bot import Bot,estimate_tokens
