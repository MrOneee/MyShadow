...
from myshadow.member_memory_policy import command, manage_intent
from myshadow.social_memory import SocialMemory, digest, member_key
...
class MemberMemoryTests(unittest.TestCase):
    ...
    def test_recall_schema_allows_overview_and_host_validation_feedback(self):
        ...
        from myshadow.member_memory_policy import RECALL_TOOL,OUTPUT
